...
export default function PlayerCard() {
  ...
  return (
    <>
      ...
      <h1 className={`text-center text-xl ${styles.interSemiBold} -mt-8 mb-8`}> Pick player 1st card </h1>
      <main className='flex flex-col pt-16 items-center shadow-2xl w-10/12 h-[30rem] bg-[#fff] -mt-4 rounded-2xl'>
      ...
      <Link href="#" className={`text-white mt-5 bg-[#45A6D5] hover:transition-all hover:duration-500 hover:cursor-pointer hover:text-black hover:bg-white border-2 border-solid hover:border-[#45a6d5] rounded-full px-24 py-2 font-semibold ${styles.interSemiBold}`}> Start Game </Link>
    </>
  )
