...
export default function StrikethroughLine( {bottomPos, rightPos, width, height, borderBottomWidth, borderRightWidth, rotateDeg} ) {
  return (
    <tr className={`absolute bottom-[${bottomPos}rem] right-[${rightPos}rem] transform rotate-[${rotateDeg}deg]`} style={{ borderBottom:`${borderBottomWidth}px solid red`, borderRight: `${borderRightWidth}px solid red`, width: `${width}rem`, height: `${height}rem`}}>
        <td colSpan="3"> </td>
    </tr>
  )
}
